...
if (count($fields) > 0) {
	...
	foreach ($cats as $cat_guid => $cat) {
		...
		foreach ($fields[$cat_guid] as $field) {
			...
			$fields_result .= "<br />";
			// add new div and class ---yanjie
			$fields_result .= "<div class='profile_manager_register_input_container'>";
			...
			$fields_result .= "<span class='elgg-icon profile_manager_validate_icon'></span>";
			$fields_result .= "</div>";
			$fields_result .= "</div>";
		}
