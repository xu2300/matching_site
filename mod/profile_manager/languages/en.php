...
$english = array(
	...
	'item:object:custom_group_field' => 'Custom Community Field',

	'profile:custom_profile_type' => 'Custom Profile Type',
	
	// admin menu
	'admin:appearance:group_fields' => "Edit Community Fields",
	'admin:appearance:export_fields' => "Export Profile Data",
	'admin:appearance:user_summary_control' => "User Summary Control",

	'admin:groups' => "Communities",
	'admin:groups:export' => "Export communities",
	...
	'profile_manager:settings:group' => "Edit Community Profile",
	...
	'profile_manager:settings:group:group_limit_name' => "Maximum number of times a community name can be edited",
	'profile_manager:settings:group:group_limit_description' => "Maximum number of times a community description can be edited",
	...
	// group fields
	'profile_manager:group_fields:list:title' => "Community Profile Fields",

	'profile_manager:group_fields:add:description' => "Here you can edit the fields that show on a community profile page",
	'profile_manager:group_fields:add' => "Add a new community profile field",
	'profile_manager:group_fields:edit' => "Edit a community profile field",
	...
	'profile_manager:actions:reset:error:wrong_type' => 'Wrong profile field type (community or profile)',
	...
	'profile_manager:actions:import:from_default:error:wrong_type' => 'Wrong profile field type (community or profile)',
	...
	'profile_manager:export:description:custom_group_field' => "This function will export all <b>community</b> metadata based on selected fields.",
	'profile_manager:export:list:title' => "Select the fields which you want to be exported",
	'profile_manager:export:list:include_group_membership' => "Include community membership",
	...
	'profile_manager:action:new:error:type' => 'Wrong profile field type (community or profile)',
	...
	'profile_manager:register_pre_check:PG13' => "Age not match! You must be 13 years or older to registrate.",
	'profile_manager:register:errorRemaining' => "Please correct any error before registrate. Check red cross for instruction.",
